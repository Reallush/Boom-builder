...
const translations = {
    en: {
        //navbar
        hello: "Welcome to Boom builders! ",
        content: " The Knockdown House Experts! Are you looking for a stylish, durable, and affordable home that’s easy to set up? At, we specialize in high-quality knockdown houses that combine modern design with convenience. Whether you need a compact home, a resort-style villa, or an office space, we have the perfect solution for you.",
    ...
    th: {
        //navbar
        hello: "สวัสดีครับ",
        content: "**ผู้เชี่ยวชาญด้านบ้านน็อคดาวน์!**    คุณกำลังมองหาบ้านที่มี **ดีไซน์สวย ทนทาน และราคาประหยัด** ที่สามารถติดตั้งได้ง่ายใช่หรือไม่?          ที่ **[ชื่อบริษัทของคุณ]** เราเชี่ยวชาญในการสร้าง **บ้านน็อคดาวน์คุณภาพสูง** ที่ผสมผสาน **การออกแบบที่ทันสมัยและความสะดวกสบาย**          ไม่ว่าคุณจะต้องการ **บ้านขนาดกะทัดรัด, วิลล่าสไตล์รีสอร์ท หรือ พื้นที่สำนักงาน** เรามีโซลูชันที่สมบูรณ์แบบสำหรับคุณ!",
...
function changeLanguage(language, page) {
    ...
    document.getElementById('content').innerHTML = translations[language].content;
